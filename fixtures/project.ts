...
export const canonicalProject = projectSpecSchema.parse({
  ...
  elements: [
    ...
    element("pergola", "pergola", "Cedar pergola", 2, 10, 16, 12, 9, 14200, "Natural cedar", "#a68059", ["pergola"]),
  ...
  assumptions: ["All dimensions and rules are illustrative fixtures.", "Estimate is a synthetic planning budget, including labor and materials; taxes and permit requirements must be verified.", "Pergola initially overlaps the demo side setback so the feasibility engine can visibly relocate it over the dining area."],
  revisionHistory: [],
